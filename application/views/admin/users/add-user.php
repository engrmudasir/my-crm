    ...
    <div class="row">
      <div class="col-lg-12">
        <section class="panel">
          <header class="panel-heading"> Add User <span class="tools pull-right"> <a class="fa fa-chevron-down" href="javascript:;"></a> </span> </header>
...
$(document).on('blur','.cell',function(){
	...
	$.ajax({
url: "<?=base_url()?>admin/users/get_user_by_cell",
type: "POST",
data: { cell : $(this).val() },
dataType: "json",
