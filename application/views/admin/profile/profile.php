                    ...
                    <div class="panel-body profile-information">
                       <div class="col-md-3">
                           <div class="profile-pic text-center">
                               <img src="images/admin_users/<?=$logged_user_info['profile_image']?>" alt=""/>
                           </div>
                       </div>
                       <div class="col-md-6">
                           <div class="profile-desk">
                               <h1><?=$logged_user_info['first_name']?> <?=$logged_user_info['last_name']?></h1>
                        ...
                        <div class="tab-content tasi-tab">
                                    ...
                                    <div class="col-md-6">
                                        <div class="prf-contacts">
                                            ...
                                            <div class="location-info">
                                                <p>Address<br>
                                                    <?=$logged_user_info['address_1']?><br>
                                                     <?=$logged_user_info['address_2']?></p>
                                                
                                            </div>
                                            <h2> <span><i class="fa fa-phone"></i></span> contacts</h2>
                                            <div class="location-info">
                                                <p>Phone	: <?=$logged_user_info['phone']?> <br>
                                                    Cell		: <?=$logged_user_info['cell']?></p>
                                                <p>Email		: <?=$logged_user_info['email']?><br>
                                                    Skype		: <?=$logged_user_info['skype']?></p>
                                                <p>
                            ...
                            <div id="settings" class="tab-pane ">
                                <div class="position-center">
                                    ...
                                    <form role="form" class="form-horizontal" enctype="multipart/form-data" action="admin/profile/update/<?=$this->session->userdata('adminId');?>" method="post">
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label"> Avatar</label>
                                            <div class="col-lg-6">
                                                <input type="file" id="exampleInputFile" name="userfile" class="file-pos">
                                                <input type="hidden" name="userfile_old" value="<?=$logged_user_info['profile_image']?>" class="file-pos">
                                            </div>
                                        </div>
                                    ...
                                    <div class="prf-contacts sttng">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" placeholder=" " name="address_1" value="<?=$logged_user_info['address_1']?>" id="addr1" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">Address 2</label>
                                            <div class="col-lg-6">
                                                <input type="text" placeholder=" " name="address_2" value="<?=$logged_user_info['address_2']?>" id="addr2" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">Phone</label>
                                            <div class="col-lg-6">
                                                <input type="text" placeholder=" " name="phone" value="<?=$logged_user_info['phone']?>" id="phone" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">Cell</label>
                                            <div class="col-lg-6">
                                                <input type="text" placeholder=" " name="cell" value="<?=$logged_user_info['cell']?>" id="cell" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">Email</label>
                                            <div class="col-lg-6">
                                                <?=$logged_user_info['email']?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">Skype</label>
                                            <div class="col-lg-6">
                                                <input type="text" placeholder=" " value="<?=$logged_user_info['skype']?>" name="skype" id="skype" class="form-control">
                                            </div>
                                        </div>
